...
package com.djsg38.locationprivacyapp.listRunningApps.adapter;
...
import static com.djsg38.locationprivacyapp.listRunningApps.picasso.AppIconRequestHandler.SCHEME_PNAME;
...
public class ProcessListAdapter extends BaseAdapter {
  ...
  @Override public View getView(int position, View convertView, ViewGroup parent) {
    ...
    if (convertView == null) {
      convertView = inflater.inflate(R.layout.content_running_apps, parent, false);
